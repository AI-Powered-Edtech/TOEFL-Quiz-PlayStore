...
export interface SpeakingData {
    part1: { prompt: string; audioId?: string; type?: 'shadowing' | 'free_response' };
    part2: { prompt: string; audioId?: string; type?: 'shadowing' | 'free_response' };
    part3: { prompt: string; audioId?: string; type?: 'shadowing' | 'free_response' };
    part4: { prompt: string; audioId?: string; type?: 'shadowing' | 'free_response' };
}
