...
import { importQuestionsToBank } from '../services/questionBankService';
...
export const PdfUploadView: React.FC<PdfUploadViewProps> = ({ onNavigate, onQuizReady }) => {
    ...
    const handleSaveToBank = async () => {
        setIsSaving(true);
        try {
            const result = await importQuestionsToBank(generatedQuestions);
    ...
    const handleSaveAndPlay = async () => {
        setIsSaving(true);
        try {
            await importQuestionsToBank(generatedQuestions);
