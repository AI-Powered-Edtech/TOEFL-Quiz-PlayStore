...
export interface ComplexityVerificationResult {
  isValid: boolean;
  feedback?: string;           // legacy fallback field
  structureAnalysis?: string;  // new
  corrections?: string[];      // new
  modelSentence?: string;      // new
  score?: number;              // new (0-100)
}
