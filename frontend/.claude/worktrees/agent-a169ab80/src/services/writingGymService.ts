...
import { WritingExercise, WritingGymLevel, WritingGymProgress, IELTSWritingTask, ComplexityLadderLevel, ComplexityVerificationResult } from '../types';
...
export const writingGymService = {
    ...
    async verifyComplexityLevel(userInput: string, levelName: string, instruction: string, topic: string): Promise<ComplexityVerificationResult> {
