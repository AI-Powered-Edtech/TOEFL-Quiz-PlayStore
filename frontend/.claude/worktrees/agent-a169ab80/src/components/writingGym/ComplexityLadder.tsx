    ...
    const submitAnswer = async () => {
        ...
        try {
            ...
            if (result.isValid) {
                ...
                setFeedback({ type: 'success', message: result.structureAnalysis ?? result.feedback ?? 'Great job!' });
                ...
                setFeedback({ type: 'error', message: result.structureAnalysis ?? result.feedback ?? 'Please try again.' });
                setStatus('playing');
            }
        } catch (error) {
